    ...
    <div className="max-w-6xl mx-auto bg-white my-10 text-sm font-['Inter']">
      ...
      <h2 className="text-xl font-bold text-gray-800 border-b border-gray-300 px-6 py-4 mb-4 flex justify-between items-center">
        ...
        <div className="space-x-2">
          <button className="border border-gray-300 bg-white px-3 py-1 text-gray-700 text-sm">
            엑셀 다운로드
          </button>
          <button className="border border-gray-300 bg-white px-3 py-1 text-gray-700 text-sm">
            프린트 설정
        ...
        <div className="flex border-b border-gray-300">
          ...
          <div className="p-2 flex items-center flex-wrap flex-grow gap-x-3">
            ...
            <div className="ml-2 flex items-center select-none">
              <span className="inline-block w-3.5 h-3.5 mr-1 border border-gray-400 bg-white align-middle"></span>
              부분검색
            </div>
          </div>
        </div>
        ...
        <div className="flex border-b border-gray-300 items-center">
          ...
          <div className="p-2 flex items-center flex-wrap flex-grow gap-x-3">
            ...
            <div className="flex items-center gap-1">
              <input
                type="date"
                className="border border-gray-300 p-1 bg-white pointer-events-none cursor-default"
                readOnly
              />
              <span>~</span>
              <input
            ...
            <div className="flex gap-1 ml-2">
              {["오늘", "1주", "15일", "1개월", "3개월", "6개월"].map(
                (label) => (
                  <button
                    key={label}
                    className="border border-gray-300 bg-white px-2 py-1 text-gray-700 text-xs cursor-default"
                  >
                    {label}
                  </button>
                )
      ...
      <div className="flex justify-center gap-4 mb-6">
        ...
        <button className="border border-gray-300 bg-white px-5 py-2 text-gray-700">
          초기화
        </button>
      </div>
